      ...
      if (searchInput?.length > 2 && searchInput?.charAt(0) != " ") {
        ...
        if (startDate && endDate >= new Date()) {
          ...
          if (
            ...
            searchInput?.toLowerCase() === "Nakuru" ||
            searchInput?.toLowerCase() === "Eldoret" 
      ...
      >
        ...
        >
          <input
            ...
            placeholder={placeholder || "Search available cars"}
          />
          <SearchIcon
            onClick={search}
        ...
        <div className="flex items-center justify-end text-gray-500 space-x-4">
          ...
          >
            <p className="hidden lg:inline cursor-pointer">Join</p>
