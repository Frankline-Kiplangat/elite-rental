...
import road from "../../public/images/hit.png";
...
const cards = [
  {
    ...
    alt: "CARD1",
    description:
      "Browse too many cars shared by owners based on and date and city.",
  },
  {
    id: 2,
    name: "Rent your Car",
    ...
    alt: "CARD2",
    description:
      "Book on Elite Car Rental and you will have damage protection insurance by default.",
  },
  {
    id: 3,
    name: "Hit the road",
